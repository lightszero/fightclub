...
//#if NETCF_1_0 || NETCF_2_0
        ...
        static Encoding defaultCodePage = Encoding.UTF8;// CultureInfo.CurrentCulture.TextInfo.ANSICodePage;
//#else
...
//#endif
		...
		public static string ConvertToString(byte[] data, int count)
		{
			...
			return DefaultCodePage.GetString(data, 0, count);
		}
		...
		public static byte[] ConvertToArray(string str)
		{
			...
			return DefaultCodePage.GetBytes(str);
		}
